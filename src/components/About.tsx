  ...
  return (
    <section className={styles.about} id="about">
      ...
      <div className={styles.social}>
        <a
          href="https://github.com/tonychen-2006"
          target="_blank"
          rel="noreferrer"
        ...
        <a
          href="https://www.linkedin.com/in/tony-chen-376028246/"
          target="_blank"
          rel="noreferrer"
          className={styles.socialLink}
          aria-label="LinkedIn"
      ...
      <div className={styles.blogWrap}>
        <p className={styles.skillsLabel}>Blog Posts</p>
