...
const posts: Post[] = [
  {
    ...
    excerpt:
      "Before working at Verdi, I only understood how to use STM32-based FreeRTOS oS threads to run concurrent tasks, and " +
      ...
      "and give me examples of Zephyr programs. I always remembered to relate the new information I learned and compared it against things that I " +
